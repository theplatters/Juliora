    """
        aggregate(eora::Eora, by::DataFrame; dims::Int=1, agg_func=sum)::Eora
    ...
    # Returns
    A new `Eora` instance with aggregated components.
    ...
    ```
    """
function aggregate(eora::Eora, by::DataFrame; dims::Int=1, agg_func=sum)::Eora
    ...
    return Eora(A_agg, T_agg, V_agg, Y_agg, L_agg, SeriesEntry(x_agg, A_agg.row_indices), env_agg)
end
